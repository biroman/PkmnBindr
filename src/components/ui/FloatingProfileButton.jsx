...
const FloatingProfileButton = ({
  ...
  return (
    <button
      onClick={handleClick}
      className={`fixed bottom-6 right-6 z-50 bg-card-background shadow-lg hover:shadow-xl border border-border rounded-full p-3 transition-all duration-200 hover:scale-105 group ${className}`}
