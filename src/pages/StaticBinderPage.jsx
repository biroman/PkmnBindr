...
const StaticBinderPage = () => {
  ...
  return (
    <>
      {/* SEO Metadata */}
      <Helmet>
        <title>{binderData.seo.title}</title>
        <meta name="description" content={binderData.seo.description} />
        <meta name="keywords" content={binderData.seo.keywords} />

        {/* Open Graph */}
        <meta property="og:title" content={binderData.seo.title} />
        <meta property="og:description" content={binderData.seo.description} />
        <meta property="og:image" content={binderData.seo.ogImage} />
        <meta
          property="og:url"
          content={`https://pkmnbindr.com/binders/${slug}`}
        />
        <meta property="og:type" content="website" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={binderData.seo.title} />
        <meta name="twitter:description" content={binderData.seo.description} />
        <meta name="twitter:image" content={binderData.seo.ogImage} />

        {/* Canonical URL */}
        <link rel="canonical" href={binderData.seo.canonicalUrl} />
